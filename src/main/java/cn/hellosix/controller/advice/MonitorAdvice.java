...
public class MonitorAdvice {
     ...
     * @return
     */
    @Around( "execution(* cn.hellosix.controller.supper.JSApiController.apiRestful(..))" )
    ...
    private Object accessInit(ProceedingJoinPoint proceedingJoinPoint) {
        ...
        try {
            ...
            String msg = msgType + LOG_SEPARATOR + clientIp + LOG_SEPARATOR + path + LOG_SEPARATOR + param + LOG_SEPARATOR + stopWatch.getTotalTimeMillis();
