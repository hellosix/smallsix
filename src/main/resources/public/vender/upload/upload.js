    ...
    $.fn.upload = function(look_call_back){
        var  _this = $(this),
            ...
            config = {
                ...
                size : _this.attr('data-size') ? _this.attr('data-size') : 60480,
        ...
        if(config.value) //初始化
        {
            ...
            for (var item in value) {
                if(i < config.num && value[i])
                {
                    ...
                    if( value[i].indexOf(".mp3") > -1 || value[i].indexOf(".wav") > -1 ){
