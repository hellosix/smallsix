...
/**
 * @type POST 
 * @param  cn.hellosix.model.FieldForm@35ef439e
 */
 ...
 * @param  int
 */
function  getGroupByUserAgent(database,startTime,endTime,callback){
   ajax.async_get("/admin/monitor/getGroupByUserAgent?database="+database+"&startTime="+startTime+"&endTime="+endTime+"",callback);
}
/**
 * @type GET 
 * @param  String 
 ...
 * @param  String
 */
function  getGroupByCountTotal(database,startTime,endTime,date,callback){
   ajax.async_get("/admin/monitor/getGroupByCountTotal?database="+database+"&startTime="+startTime+"&endTime="+endTime+"&date="+date+"",callback);
}
/**
 * @type GET 
 * @param  String 
 ...
 * @param  int
 */
function  getTotalCount(database,startTime,endTime,callback){
   ajax.async_get("/admin/monitor/getTotalCount?database="+database+"&startTime="+startTime+"&endTime="+endTime+"",callback);
}
/**
 * @type GET 
 * @param  String
